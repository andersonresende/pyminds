...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.forgot'
        db.add_column(u'review_question', 'forgot',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.forgot'
        db.delete_column(u'review_question', 'forgot')


    models = {
        u'review.question': {
            'Meta': {'object_name': 'Question'},
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 29, 0, 0)'}),
            'forgot': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
